  ...
  return (
    <Card className='bg-secondary text-white'>
      <Card.Body>
        ...
        <Card.Link href="#">Look for Clues around the Crime Scene</Card.Link>
        <Card.Link href="#">Torture the prisoner until they tell you what they know</Card.Link>
        <Card.Link href='#'>Using my Class abilities, I investigate the town</Card.Link>
      </Card.Body>
    </Card>
  );
}
