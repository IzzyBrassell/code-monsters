  ...
  return (
    <Card className='bg-secondary text-white'>
      <Card.Body>
        ...
        <Card.Text>
        The (Heroine/Hero) knew that the cultists held valuable information that could lead them to the dragon lair. (Pronoun) set out to find the cultists and after several days of tracking, (Pronoun) finally caught up with them. The cultists were hesitant to share (Possessive Pronoun) secrets with the (Heroine/Hero), but after some persuasion, (Pronoun) agreed to lead the (Heroine/Hero) to the dragon lair. The journey was treacherous, but the (Heroine/Hero) remained focused, determined to get to the lair and learn as much as (Pronoun) could about the dragon. Finally, (Pronoun) arrived at the lair, hidden deep within the mountain. The (Heroine/Hero) couldn't help but feel a sense of foreboding as (Pronoun) peered into the darkness of the cave, wondering what kind of danger lay ahead.
        ...
        <Card.Link href="#">Steel yourself</Card.Link>
        <Card.Link href="#">Trick the Dragon</Card.Link>
        <Card.Link href='#'>Use your abilities to change the tide of battle</Card.Link>
      </Card.Body>
    </Card>
  );
}

export default Scene5a;