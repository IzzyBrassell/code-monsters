  ...
  return (
    <Card className='bg-secondary text-white'>
      <Card.Body>
        ...
        <Card.Link href="#">Kill the Bandits</Card.Link>
        <Card.Link href="#">Pay the Bandit’s Toll ($20)</Card.Link>
        <Card.Link href='#'>Get The Bandits to Protect the Town</Card.Link>
      </Card.Body>
    </Card>
  );
}
